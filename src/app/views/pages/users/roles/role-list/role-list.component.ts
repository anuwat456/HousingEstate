// Angular
import { Component, OnInit, ElementRef, ChangeDetectionStrategy, ViewChild, OnDestroy } from '@angular/core';
// Material
...
export class RoleListComponent implements OnInit, OnDestroy {
	...
	editRole(role: Role) {
		...
		const dialogRef = this.dialog.open(RoleEditComponent, { data: { roleId: role.id } });
		dialogRef.afterClosed().subscribe(res => {
			if (!res) {
				return;
			}
